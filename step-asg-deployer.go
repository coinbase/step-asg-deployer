...
import (
	...
	"github.com/coinbase/step-asg-deployer/deployer"
	"github.com/coinbase/step-asg-deployer/deployer/client"
...
func printUsage() {
	fmt.Println("Usage: step-asg-deployer <json|exec|deploy> <arg> (No args starts Lambda)")
	os.Exit(0)
}
